...
export default function Card({
  ...
  const classes = {
    ...
    cardContent: cn(
      'mb-auto line-clamp-3 text-[12px] leading-normal break-keep md:line-clamp-4 md:text-[16px] lg:text-[24px]',
      contentClassName,
    ),
    cardAuthor:
      'mt-[6px] text-right text-[12px] leading-normal text-blue-400 md:mt-0 md:text-[16px] lg:mt-3 lg:text-[24px]',
    cardTag:
      'mt-2 flex flex-wrap justify-end gap-x-2 text-right text-[12px] leading-normal text-blue-400 md:text-[16px] lg:text-[24px]',
  };
